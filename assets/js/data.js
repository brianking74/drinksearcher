...
const drinksInventory = [
  ...
  ,
  {name:'Yamazaki 12 Year Old', supplier:'Watson\'s Wine', supplierSlug:'watsons-wine', area:'Pacific Place', type:'Whisky', price:'HK$1,880', image:'assets/images/whisky-bar.jpg', tier:'enhanced', buy:'https://www.watsonswine.com/', description:'Japan\'s iconic single malt whisky from the Yamazaki distillery. Renowned for its harmony of fruit, spice, and Mizunara oak influence, with a smooth, lingering finish.', origin:'Osaka, Japan', abv:'43%'},
  ,
  {name:'Dassai 23 Junmai Daiginjo', supplier:'Sake Central', supplierSlug:'sake-central-supplier', area:'Central', type:'Sake', price:'HK$880', image:'assets/images/sake.jpg', tier:'enhanced', buy:'https://www.sakecentral.com.hk/', description:'A premium sake crafted from Yamada Nishiki rice polished to 23%, delivering an exquisite balance of fruity aromas and umami depth.', origin:'Yamaguchi, Japan', abv:'16%'},
  ,
  {name:'Krug Grande Cuv\u00e9e 170\u00e8me', supplier:'Ponti Wine Cellars', supplierSlug:'ponti', area:'Central', type:'Champagne', price:'HK$1,950', image:'assets/images/champagne.jpg', tier:'enhanced', buy:'https://www.pontiwinecellars.com.hk/', description:'The benchmark of prestige Champagne. A multi-vintage blend of over 120 wines from 10+ years, offering extraordinary depth, toast, and citrus complexity.', origin:'Reims, France', abv:'12%'},
  ,
  {name:'Neon City Pale Ale', supplier:'Young Master Ales', supplierSlug:'young-master', area:'Wong Chuk Hang', type:'Craft Beer', price:'HK$28', image:'assets/images/craft-beer.jpg', tier:'enhanced', buy:'https://www.youngmasterales.com/', description:'Young Master\'s flagship pale ale — bright, hoppy, and refreshing with citrus and pine notes.', origin:'Hong Kong', abv:'5.2%'},
  ,
  {name:'Opus One 2018', supplier:'Ponti Wine Cellars', supplierSlug:'ponti', area:'Central', type:'Wine', price:'HK$3,650', image:'assets/images/wine-bar.jpg', tier:'enhanced', buy:'https://www.pontiwinecellars.com.hk/', description:'A Napa Valley icon. The 2018 vintage delivers opulent dark fruit, cassis, and a velvety finish.', origin:'Napa Valley, USA', abv:'14.5%'},
  ,
  {name:'Michter\u2019s US*1 Rye', supplier:'House of Connoisseur', supplierSlug:null, area:'Admiralty', type:'Whisky', price:'HK$620', image:'assets/images/whisky-bar.jpg', tier:'featured', description:'A supremely smooth American rye whiskey from Kentucky, with rich notes of caramel, spice, and toasted oak.', origin:'Kentucky, USA', abv:'45.5%'},
  ,
  {name:'Grower Champagne NV', supplier:'Nomad Cellars', supplierSlug:null, area:'Tsim Sha Tsui', type:'Champagne', price:'HK$540', image:'assets/images/champagne.jpg', tier:'featured', description:'A non-vintage grower Champagne with expressive, terroir-driven bubbles and crisp apple, brioche, and mineral notes.', origin:'Champagne, France', abv:'12%'},
  ,
  {name:'Junmai Flight Box', supplier:'Sake no Wa', supplierSlug:null, area:'Central', type:'Sake', price:'HK$420', image:'assets/images/sake.jpg', tier:'featured', description:'A curated selection of junmai-grade sakes showing the diversity of rice and brewing styles.', origin:'Japan (various)', abv:'15-17%'},
  ,
  {name:'Botanical Gin Discovery Set', supplier:'Ginsanity', supplierSlug:'ginsanity', area:'Central', type:'Gin', price:'HK$760', image:'assets/images/gin-bar.jpg', tier:'enhanced', buy:'#', description:'A tasting flight of artisanal gins featuring distinctive botanicals from juniper to hibiscus.', origin:'Various', abv:'40-45%'},
  ,
  {name:'Alcohol-Free Aperitif Bundle', supplier:'NoLo Bottles', supplierSlug:null, area:'Sheung Wan', type:'Non-Alcoholic', price:'HK$310', image:'assets/images/cocktail-bar.jpg', tier:'featured', description:'A non-alcoholic aperitif bundle crafted from botanical extracts.', origin:'Various', abv:'0%'},
  ,
  {name:'Bordeaux Discovery Case', supplier:'La Cabane', supplierSlug:'lacabane', area:'Sheung Wan', type:'Wine', price:'HK$1,180', image:'assets/images/wine-bar.jpg', tier:'enhanced', buy:'#', description:'A mixed case of six Bordeaux wines showcasing the region\'s diversity.', origin:'Bordeaux, France', abv:'12.5-14%'},
  ,
  ...
  ,
  {name:'Cincoro Reposado Tequila', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$1,898', image:'https://www.hkdrinks.shop/images/cincoro-reposado.jpg', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Aged 8-10 months in American oak. Beautifully balanced with vanilla, caramel, and cooked agave.', origin:'Jalisco, Mexico', abv:'40%'},
  ,
  {name:'Cincoro Anejo Tequila', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$2,288', image:'https://www.hkdrinks.shop/images/cincoro-anejo.jpg', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Aged 24-28 months. Rich with dark chocolate, dried fruit, toasted oak, and butterscotch.', origin:'Jalisco, Mexico', abv:'40%'},
  ,
  {name:'Cincoro Extra Anejo Tequila', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$15,988', image:'https://www.hkdrinks.shop/images/cincoro-extra-anejo.jpg', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Aged 40-44 months. Intensely layered with dark caramel, leather, tobacco, and dried fig.', origin:'Jalisco, Mexico', abv:'40%'},
  ,
  {name:'Cincoro Gold Tequila', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$3,488', image:'https://www.hkdrinks.shop/images/cincoro-gold.jpg', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'A distinctive blend of aged añejo with natural agave nectar. Honeyed agave, vanilla, and oak.', origin:'Jalisco, Mexico', abv:'35%'},
  ,
  {name:'Cincoro Collection', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$24,498', image:'https://www.hkdrinks.shop/images/cincoro-collection.jpg', tier:'featured', description:'The complete Cincoro collection in a presentation case.', origin:'Jalisco, Mexico', abv:'35-40%'},
  ,
  {name:'Clase Azul Plata', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$1,898', image:'https://www.hkdrinks.shop/images/clase-azul-plata.jpg', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Unaged plata tequila from 100% Blue Weber agave. Notes of agave nectar, citrus zest, and white flowers.', origin:'Jalisco, Mexico', abv:'40%'},
  ,
  {name:'Clase Azul Reposado', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$1,898', image:'https://www.hkdrinks.shop/images/clase-azul-reposado.jpg', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Unaged plata tequila from 100% Blue Weber agave. Notes of agave nectar, citrus zest, and white flowers.', origin:'Jalisco, Mexico', abv:'40%'},
  ,
  {name:'Clase Azul Gold', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$3,998', image:'https://www.hkdrinks.shop/images/clase-azul-gold.jpg', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Unaged plata tequila from 100% Blue Weber agave. Notes of agave nectar, citrus zest, and white flowers.', origin:'Jalisco, Mexico', abv:'40%'},
  ,
  {name:'Clase Azul Anejo', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$8,198', image:'https://www.hkdrinks.shop/images/clase-azul-anejo.jpg', tier:'featured', description:'Unaged plata tequila from 100% Blue Weber agave. Notes of agave nectar, citrus zest, and white flowers.', origin:'Jalisco, Mexico', abv:'40%'},
  ,
  {name:'Clase Azul Ultra', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$29,888', image:'https://www.hkdrinks.shop/images/clase-azul-ultra.jpg', tier:'featured', description:'Unaged plata tequila from 100% Blue Weber agave. Notes of agave nectar, citrus zest, and white flowers.', origin:'Jalisco, Mexico', abv:'40%'},
  ,
  {name:'Clase Azul Durango Mezcal', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Mezcal', price:'HK$4,498', image:'https://www.hkdrinks.shop/images/clase-azul-durango.jpg', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Unaged plata tequila from 100% Blue Weber agave. Notes of agave nectar, citrus zest, and white flowers.', origin:'Jalisco, Mexico', abv:'40%'},
  ,
  {name:'Clase Azul Guerrero Mezcal', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Mezcal', price:'HK$4,498', image:'https://www.hkdrinks.shop/images/clase-azul-guerrero.jpg', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Unaged plata tequila from 100% Blue Weber agave. Notes of agave nectar, citrus zest, and white flowers.', origin:'Jalisco, Mexico', abv:'40%'},
  ,
  {name:'Clase Azul San Luis Potosi Mezcal', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Mezcal', price:'HK$4,998', image:'https://www.hkdrinks.shop/images/clase-azul-slp.jpg', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Unaged plata tequila from 100% Blue Weber agave. Notes of agave nectar, citrus zest, and white flowers.', origin:'Jalisco, Mexico', abv:'40%'},
  ,
  {name:'Clase Azul Ahumado', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Mezcal', price:'HK$3,898', image:'https://www.hkdrinks.shop/images/clase-azul-ahumado.jpg', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Unaged plata tequila from 100% Blue Weber agave. Notes of agave nectar, citrus zest, and white flowers.', origin:'Jalisco, Mexico', abv:'40%'},
  ,
  {name:'Clase Azul Spirit of Champions', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$17,998', image:'https://www.hkdrinks.shop/images/clase-azul-spirit-of-champions.jpg', tier:'featured', description:'Unaged plata tequila from 100% Blue Weber agave. Notes of agave nectar, citrus zest, and white flowers.', origin:'Jalisco, Mexico', abv:'40%'},
  ,
  {name:'Alfred GIRAUD Heritage 700ml', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Whisky', price:'HK$1,668', image:'https://www.hkdrinks.shop/images/alfred-giraud-heritage.png', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'A refined French whisky double-aged in French oak and cognac casks. Honeyed fruit, spice, velvety.', origin:'Cognac, France', abv:'41%'},
  ,
  {name:'Alfred GIRAUD Harmonie 700ml', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Whisky', price:'HK$2,578', image:'https://www.hkdrinks.shop/images/alfred-giraud-harmonie.png', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'A refined French whisky double-aged in French oak and cognac casks. Honeyed fruit, spice, velvety.', origin:'Cognac, France', abv:'41%'},
  ,
  {name:'Alfred GIRAUD Voyage 700ml', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Whisky', price:'HK$2,588', image:'https://www.hkdrinks.shop/images/alfred-giraud-voyage.png', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'A refined French whisky double-aged in French oak and cognac casks. Honeyed fruit, spice, velvety.', origin:'Cognac, France', abv:'41%'},
  ,
  {name:'Alfred GIRAUD Intrigue 700ml', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Whisky', price:'HK$4,718', image:'https://www.hkdrinks.shop/images/alfred-giraud-intrigue.png', tier:'featured', description:'A refined French whisky double-aged in French oak and cognac casks. Honeyed fruit, spice, velvety.', origin:'Cognac, France', abv:'41%'},
  ,
  {name:'Alfred GIRAUD Horizon 700ml', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Whisky', price:'HK$1,768', image:'assets/images/whisky-bar.jpg', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'A refined French whisky double-aged in French oak and cognac casks. Honeyed fruit, spice, velvety.', origin:'Cognac, France', abv:'41%'},
  ,
  {name:'Alfred GIRAUD Une Odyssee 700ml', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Whisky', price:'HK$24,988', image:'https://www.hkdrinks.shop/images/alfred-giraud-une-odyssee.png', tier:'featured', description:'A refined French whisky double-aged in French oak and cognac casks. Honeyed fruit, spice, velvety.', origin:'Cognac, France', abv:'41%'}
];
