...
const venueListings = {
  enhanced: [
    ...
    {slug:'sugar', name:'Sugar', area:'Taikoo Shing', phone:'+852 3968 3730', cuisine:'Rooftop Bar', price:'$$$', rating:'4.4', booking:'Website', specialty:'Sunset Cocktails', image:'assets/images/rooftop-bar.jpg', website:'https://www.sugar-hk.com/'},
    {slug:'ozone', name:'OZONE', area:'West Kowloon', phone:'+852 2263 2270', cuisine:'Hotel Bar', price:'$$$$', rating:'4.6', booking:'Ritz-Carlton', specialty:'Highest Bar World', image:'assets/images/rooftop-bar.jpg', website:'https://www.ritzcarlton.com/en/hotels/hong-kong/dining/ozone'},
    {slug:'popinjays', name:'Popinjays', area:'Central', phone:'+852 3141 8888', cuisine:'Rooftop Bar', price:'$$$$', rating:'4.5', booking:'The Murray', specialty:'Heritage Terrace', image:'assets/images/rooftop-bar.jpg', website:'https://www.niccolohotels.com/en/murray-hong-kong/restaurants-and-bars/popinjays'},
    {slug:'aqua-spirit', name:'Aqua Spirit', area:'Tsim Sha Tsui', phone:'+852 3427 2288', cuisine:'Cocktail Bar', price:'$$$', rating:'4.5', booking:'Website', specialty:'Skyline Views', image:'assets/images/rooftop-bar.jpg', website:'https://www.aqua.com.hk/'},
    {slug:'terrible-baby', name:'Terrible Baby', area:'Jordan', phone:'+852 2710 6888', cuisine:'Rooftop Bar', price:'$$$', rating:'4.3', booking:'Walk-in', specialty:'Eccentric Terrace', image:'assets/images/rooftop-bar.jpg', website:'https://www.eaton.hk/dining/terrible-baby'},
    {slug:'cruise', name:'Cruise Restaurant & Bar', area:'North Point', phone:'+852 3896 9896', cuisine:'Rooftop Bar', price:'$$$', rating:'4.5', booking:'Hyatt Centric', specialty:'Tropical Cocktails', image:'assets/images/rooftop-bar.jpg', website:'https://www.hyattcentric.com/dining/cruise'},
    {slug:'aeris', name:'Aeris', area:'Mong Kok', phone:'+852 2682 8821', cuisine:'Sky Bar', price:'$$$', rating:'4.2', booking:'Cordis Hotel', specialty:'Happy Hour', image:'assets/images/rooftop-bar.jpg', website:'https://www.cordishotels.com/en/hong-kong/dining/aeris'},
    {slug:'la-rambla-terrace', name:'La Rambla Terrace', area:'Central', phone:'+852 2661 1161', cuisine:'Spanish Bar', price:'$$$', rating:'4.3', booking:'IFC', specialty:'Mediterranean Terrace', image:'assets/images/rooftop-bar.jpg', website:'https://laramblahk.com/'},
    {slug:'topping-lane', name:'Topping Lane', area:'Central', phone:'+852 2435 0028', cuisine:'Rooftop Bar', price:'$$$', rating:'4.4', booking:'Website', specialty:'Seasonal Cocktails', image:'assets/images/rooftop-bar.jpg', website:'#'}
  ],
  featured: [
...
const drinksInventory = [
  {name:'Cincoro Blanco Tequila', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$1,498', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328722/drinks/cincoro-blanco.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'An ultra-premium blanco tequila from the highlands of Jalisco. Bright citrus, white pepper, and silky agave sweetness with a clean, vibrant finish.', origin:'Jalisco, Mexico', abv:'40%'},
  {name:'Cincoro Reposado Tequila', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$1,898', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/cincoro-reposado.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Aged in American oak barrels for a balanced expression. Rested for smoothness while retaining agave character, with notes of vanilla, caramel, and toasted oak.', origin:'Jalisco, Mexico', abv:'40%'},
  {name:'Cincoro Anejo Tequila', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$2,288', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/cincoro-anejo.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Aged 24 months in American oak. Rich and complex with dark chocolate, dried cherry, roasted agave, and a lingering spiced finish.', origin:'Jalisco, Mexico', abv:'40%'},
  {name:'Cincoro Extra Anejo Tequila', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$15,988', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/cincoro-extra-anejo.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Aged for 4+ years in new American oak. Decadent, sherry-like with dried fruit, tobacco, leather, and an exceptionally long, elegant finish.', origin:'Jalisco, Mexico', abv:'40%'},
  {name:'Cincoro Gold Tequila', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$3,488', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/cincoro-gold.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'The crown jewel of the Cincoro portfolio blended with reposado and extra-anejo. Opulent with notes of butterscotch, dark chocolate, dried orange peel, and a velvety finish.', origin:'Jalisco, Mexico', abv:'40%'},
  {name:'Cincoro Collection', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$24,498', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/cincoro-collection.webp', tier:'featured', description:'The complete Cincoro lineup in one exclusive set. Blanco, Reposado, Anejo, Extra Anejo, and Gold. The definitive ultra-premium tequila tasting experience.', origin:'Jalisco, Mexico', abv:'40%'},
  {name:'Clase Azul Plata', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$1,898', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/clase-azul-plata.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'A vibrant, unaged plata from the highlands of Jalisco. Crisp and clean with fresh agave, citrus zest, and white flowers bottled in the iconic handmade ceramic decanter.', origin:'Jalisco, Mexico', abv:'40%'},
  {name:'Clase Azul Reposado', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$1,898', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/clase-azul-reposado.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Aged for eight months in American oak and Bourbon casks. Smooth and warm with notes of vanilla, caramel, and honey. The worlds most recognized reposado.', origin:'Jalisco, Mexico', abv:'40%'},
  {name:'Clase Azul Gold', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$3,998', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/clase-azul-gold.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'A blend of reposado, anejo, and extra-anejo tequilas finished in Sherry casks. Luxuriously layered with dried fruit, nutmeg, and dark toffee.', origin:'Jalisco, Mexico', abv:'40%'},
  {name:'Clase Azul Anejo', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$8,198', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/clase-azul-anejo.webp', tier:'featured', description:'Aged for 25 months in American whiskey barrels. Deep amber with rich notes of cooked agave, oak spice, dark chocolate, and dried plum.', origin:'Jalisco, Mexico', abv:'40%'},
  {name:'Clase Azul Ultra', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$29,888', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/clase-azul-ultra.webp', tier:'featured', description:'Extra-anejo aged for five years in a combination of fine wine, American whiskey, and Sherry casks. Presented in a limited-edition porcelain decanter adorned with 24k gold.', origin:'Jalisco, Mexico', abv:'40%'},
  {name:'Clase Azul Durango Mezcal', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Mezcal', price:'HK$4,498', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/clase-azul-durango.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'An artisanal mezcal from Durango. Smoky and complex with notes of roasted agave, green herbs, and mineral earthiness from the Cenizo agave.', origin:'Durango, Mexico', abv:'42%'},
  {name:'Clase Azul Guerrero Mezcal', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Mezcal', price:'HK$4,498', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/clase-azul-guerrero.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'A wild-harvested mezcal from Guerrero made with papalote agave. Bold smoke, wild honey, tropical fruit, and a distinctive earthy minerality.', origin:'Guerrero, Mexico', abv:'43%'},
  {name:'Clase Azul San Luis Potosi Mezcal', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Mezcal', price:'HK$4,998', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/clase-azul-slp.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Crafted with Salmiana agave from the high plateau. Herbaceous and elegant with a signature green pepper note, citrus, and gentle smoke.', origin:'San Luis Potos\u00ed, Mexico', abv:'42%'},
  {name:'Clase Azul Ahumado', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Mezcal', price:'HK$3,898', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/clase-azul-ahumado.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'A smoked expression using volcanic stone pit-roasted agave. Intense campfire smoke, dark fruits, and a savory, peppery finish.', origin:'Jalisco, Mexico', abv:'43%'},
  {name:'Clase Azul Spirit of Champions', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Tequila', price:'HK$17,998', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/clase-azul-spirit-of-champions.webp', tier:'featured', description:'A limited-edition extra-anejo celebrating global champions. Aged five years in select oak casks with a stunning hand-painted ceramic decanter in Deep Amethyst.', origin:'Jalisco, Mexico', abv:'40%'},
  {name:'Alfred GIRAUD Heritage 700ml', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Whisky', price:'HK$1,668', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/alfred-giraud-heritage.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'A San Maroma single-cask release from the house of Alfred GIRAUD. Matured in French oak, offering layers of tropical fruit, vanilla, milk chocolate and a whisper of smoke.', origin:'Guadalajara, Mexico', abv:'42%'},
  {name:'Alfred GIRAUD Harmonie 700ml', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Whisky', price:'HK$2,578', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/alfred-giraud-harmonie.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'A refined blend aged in French Cognac casks. Delicate floral notes lead into honeyed stone fruit, toasted almond, and a silky, lingering finish.', origin:'Guadalajara, Mexico', abv:'42%'},
  {name:'Alfred GIRAUD Voyage 700ml', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Whisky', price:'HK$2,588', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/alfred-giraud-voyage.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'Finished in Sauternes wine casks for an exotic sweetness. Apricot, honeycomb, gingerbread, and a touch of white pepper make this an adventurous pour.', origin:'Guadalajara, Mexico', abv:'42%'},
  {name:'Alfred GIRAUD Intrigue 700ml', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Whisky', price:'HK$4,718', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/alfred-giraud-intrigue.webp', tier:'featured', description:'A limited-release finished in Pedro Ximenez Sherry casks. Dark and decadent with fig, raisin, dark chocolate, roasted coffee, and a seductive finish.', origin:'Guadalajara, Mexico', abv:'45%'},
  {name:'Alfred GIRAUD Horizon 700ml', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Whisky', price:'HK$1,768', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785294514/Alfred_Giraud_Horizon_hltzb9.webp', tier:'enhanced', buy:'https://www.hkdrinks.shop/', description:'A double-matured tequila finished in Cognac French oak. Balanced and approachable with creamy vanilla, dried pear, almond croissant, and gentle baking spices.', origin:'Guadalajara, Mexico', abv:'42%'},
  {name:'Alfred GIRAUD Une Odyssee 700ml', supplier:'HK Drinks', supplierSlug:'hkdrinks', area:'Central', type:'Whisky', price:'HK$24,988', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785328721/drinks/alfred-giraud-une-odyssee.webp', tier:'featured', description:'The flagship extra-anejo from Alfred GIRAUD aged 42 months in new French oak. An olfactory journey with dark berry compote, cocoa, leather, candied orange peel, and an epic finish.', origin:'Guadalajara, Mexico', abv:'45%'},
  {name:'Nikka From The Barrel', supplier:"Watson's Wine", area:'Central', type:'Whisky', price:'HK$698', image:'https://res.cloudinary.com/rqokncht/image/upload/v1785289785/Nikka_From_The_Barrel_idbzb8.webp', tier:'standard', origin:'Japan', abv:'43%', description:'A well-balanced blended whisky from Nikka. Rye and malt combine for a rich, spicy profile with hints of vanilla, oak, and dried fruit.'},
];
