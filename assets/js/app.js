...
async function renderHomepage() {
  ...
  const events = [
    ...
    { name:'Japanese Whisky Flight Night', venue:'Quinary, Central', date:'Nov 22', type:'Whisky', image:siteImages.event },
    { name:'Natural Wine Tasting', venue:'La Cabane, Soho', date:'Nov 25', type:'Wine', image:siteImages.hero },
    { name:'Zero-Proof Cocktail Lab', venue:'PMQ, Central', date:'Dec 02', type:'Non-Alcoholic', image:siteImages.event }
  ];
...
async function renderVenueProfile() {
  ...
  const image = v.image || siteImages.event;
    ...
    return `
      <div class="dashboard-shell">
        <section class="hero" style="min-height:52vh;">
          <div class="hero-media" style="background-image:url('${role === 'merchant' ? siteImages.shop : siteImages.event}')"></div>
          <div class="container hero-grid">
            <div class="hero-copy">
