    ...
    <section class="hero" style="min-height:64vh;">
      ...
      <div class="container hero-grid">
        <div class="hero-copy">
          ...
          <h1>Pricing for <span class="text-jade">merchants</span> & <span class="text-pink">bars</span>.</h1>
...
function renderSearcherAccountPage() {
  ...
  app.innerHTML = `
    <section class="hero" style="min-height:62vh;"><div class="hero-media" style="background-image:url('${siteImages.hero}')"></div><div class="container hero-grid"><div class="hero-copy"><span class="kicker">Searcher Account</span><h1>Your drinks shortlist, anywhere.</h1><p class="lead">Save bottles, venues, and events. Track your finds. One account for everything.</p></div></div></section>
    ...
    <section class="hero" style="min-height:54vh;">
      ...
      <div class="container hero-grid">
        <div class="hero-copy">
          ...
          <h1>Manage <span class="text-jade">suppliers</span>, <span class="text-pink">venues</span> & subscriptions.</h1>
