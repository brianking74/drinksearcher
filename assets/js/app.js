...
function renderSupplierProfile() {
  ...
  app.innerHTML = `
    ...
    <section id="inventory" class="section-tight"><div class="container"><div class="section-head"><div><span class="eyebrow">Live Inventory</span><h2>What's ready to order right now.</h2><p class="lead" style="margin-top:14px;">Every bottle below streams live from ${profile.name}'s own catalogue — prices and availability refresh automatically so you're always looking at current stock.</p></div></div><div id="sheet-inventory-${slug}"><p class="muted">Loading inventory...</p></div></div></section>
