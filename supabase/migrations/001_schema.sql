...
-- Also seed the classic drinks from data.js
INSERT INTO drinks (name, supplier_name, type, price, image, buy_url, description, origin, abv, tier, status) VALUES
('Château Margaux 2015', 'Watson''s Wine', 'Wine', 'HK$7,980', 'assets/images/wine-bar.jpg', 'https://www.watsonswine.com/', 'A grand cru classé from Bordeaux''s legendary Margaux appellation. The 2015 vintage is celebrated for its aromatic complexity of dark fruits, violets, and spice, with silky tannins and exceptional length.', 'Bordeaux, France', '13.5%', 'enhanced', 'approved'),
('Yamazaki 12 Year Old', 'Watson''s Wine', 'Whisky', 'HK$1,880', 'assets/images/whisky-bar.jpg', 'https://www.watsonswine.com/', 'Japan''s quintessential single malt whisky. Elegantly balanced with honeyed sweetness, Mizunara oak spice, dried fruit, and a lingering smoky finish.', 'Osaka, Japan', '43%', 'enhanced', 'approved'),
('Dassai 23 Junmai Daiginjo', 'Sake Central', 'Sake', 'HK$880', 'assets/images/sake.jpg', 'https://www.sakecentral.com.hk/', 'The pinnacle of sake craftsmanship. Dassai 23 is polished to 23% of its original grain, yielding an impossibly clean, fragrant brew with notes of lychee, white melon, and a silky finish.', 'Yamaguchi, Japan', '16%', 'enhanced', 'approved'),
('Krug Grande Cuvée 170ème', 'Ponti Wine Cellars', 'Champagne', 'HK$1,950', 'assets/images/champagne.jpg', 'https://www.pontiwinecellars.com.hk/', 'An icon of Champagne. The 170ème édition blends more than 190 wines from 12 different years, resulting in a rich, full-bodied cuvée with notes of brioche, citrus, and toasted almond.', 'Reims, France', '12.5%', 'enhanced', 'approved'),
('Neon City Pale Ale', 'Young Master Ales', 'Craft Beer', 'HK$28', 'assets/images/craft-beer.jpg', 'https://www.youngmasterales.com/', 'A vibrant, hop-forward pale ale brewed in Hong Kong. Bright citrus and tropical fruit aromas with a crisp, clean bitterness and a refreshing finish.', 'Wong Chuk Hang, Hong Kong', '5.2%', 'enhanced', 'approved'),
('Opus One 2018', 'Ponti Wine Cellars', 'Wine', 'HK$3,650', 'assets/images/wine-bar.jpg', 'https://www.pontiwinecellars.com.hk/', 'The flagship Napa Valley Bordeaux-blend from the legendary partnership of Robert Mondavi and Baron Philippe de Rothschild. The 2018 vintage offers layers of cassis, dark cherry, cedar, and finely integrated tannins.', 'Oakville, California', '14.5%', 'enhanced', 'approved'),
('Michter''s US*1 Rye', 'House of Connoisseur', 'Whisky', 'HK$620', 'assets/images/whisky-bar.jpg', '#', 'A small-batch Kentucky straight rye whiskey. Bold and spicy with notes of clove, cinnamon, and black pepper balanced by vanilla sweetness and a long, warm finish.', 'Kentucky, USA', '46.4%', 'featured', 'approved'),
('Grower Champagne NV', 'Nomad Cellars', 'Champagne', 'HK$540', 'assets/images/champagne.jpg', '#', 'An artisanal grower-producer Champagne showcasing the true character of the terroir. Fine bubbles with crisp apple, pear, and a brioche undertone.', 'Champagne, France', '12%', 'featured', 'approved'),
('Junmai Flight Box', 'Sake no Wa', 'Sake', 'HK$420', 'assets/images/sake.jpg', '#', 'A curated selection of premium junmai sake. Rich umami, rice-forward character with subtle fruit notes, perfect for exploring traditional sake styles.', 'Multiple regions, Japan', '15-16%', 'featured', 'approved'),
('Botanical Gin Discovery Set', 'Ginsanity', 'Gin', 'HK$760', 'assets/images/gin-bar.jpg', '#', 'A tasting journey through artisanal gins from around the world. Each bottle showcases unique botanicals from Japanese yuzu to Moroccan rose.', 'Multiple origins', '40-47%', 'enhanced', 'approved'),
('Alcohol-Free Aperitif Bundle', 'NoLo Bottles', 'Non-Alcoholic', 'HK$310', 'assets/images/cocktail-bar.jpg', '#', 'Sophisticated non-alcoholic alternatives for mindful drinking. Botanical-forward blends with natural bitterness, citrus, and spice with zero compromise.', 'Various', '0%', 'featured', 'approved'),
('Bordeaux Discovery Case', 'La Cabane', 'Wine', 'HK$1,180', 'assets/images/wine-bar.jpg', '#', 'A handpicked selection of Bordeaux wines across appellations. From vibrant left-bank Cabernets to elegant right-bank Merlots, a tour of the region in a case.', 'Bordeaux, France', '13-14.5%', 'enhanced', 'approved');
